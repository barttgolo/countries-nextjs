...
export type AllCountriesCodeQueryVariables = Exact<{ [key: string]: never }>;

export type AllCountriesCodeQuery = {
  __typename?: "Query";
...
export const AllCountriesCodeDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "AllCountriesCode" },
      selectionSet: {
        kind: "SelectionSet",
        selections: [
          {
  ...
  AllCountriesCodeQuery,
  AllCountriesCodeQueryVariables
>;
export const GetCountryByCodeDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "GetCountryByCode" },
      variableDefinitions: [
        {
